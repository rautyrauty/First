...
//Áèíàðíûé ïîèñê êîðíÿ ôóíêöèè f(x)
...
//Ïðèìåð ðåøåíèå 27 çàäàíèÿ ÅÃÝ ñî çìåéêîé
...
//Ïîïûòêà â ñòðóêòóðû è íîâûé îïåðàòîð
//Çàäà÷à ñ ïîèñêîì ËÞÄÅÉ ñ ìàêñèìàëüíûì âîçðàñòîì
struct Person {
	int age;
	string name;
};
...
//Çàäà÷à ñ ïðîâåðêîé ïðàâèëüíîñòè íàïèñàíèÿ ðàçíûõ âèäîâ ñêîáîê â ìàòåì. âûðàæåíèè 
void skobki() // Çàäà÷à ïðî ðàçíûå âèäû ñêîáîê
{
	string a; vector<char> A(10);int THE_END = 0; // Çàäàíèå ïðî ÑÒÅÊ, îáúÿâëåíèå ñòðîêè, ñòåêà è êîíöà ñòåêà ñîîòâåòñòâåííî
	cout << "Enter the virajenie: ";cin >> a; // Ââîä âûðàæåíèÿ ñî ñêîáêàìè(èëè áåç)
	bool f = 1; //ôëàã äëÿ îïðåäåëåíèÿ êîððåêòíîñòè ïîñëåäîâàòåëüíîñòè ââåä¸íûõ ñêîáîê
	for (int i = 0; a[i] != '\0'; i++)
	{
		switch (a[i])
		{
