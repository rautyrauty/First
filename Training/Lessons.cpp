...
//Бинарный поиск корня функции f(x)
...
//Пример решение 27 задания ЕГЭ со змейкой
void zmeyka27() { // Решение задачи 27 с идеей со змейкой
	const int Q_size = 5;
	int Q[Q_size];
...
//Попытка в структуры и новый оператор
//Задача с поиском ЛЮДЕЙ с максимальным возрастом
struct Person {
	int age;
	string name;
};
...
//Задача с проверкой правильности написания разных видов скобок в матем. выражении 
void skobki() // Задача про разные виды скобок
{
